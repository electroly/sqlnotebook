...
public sealed partial class ScriptTest {
    ...
    [TestMethod] public void Test_IMPORT_XLS_FIRST_COLUMN_sql() => TestScript(@"IMPORT XLS FIRST_COLUMN.sql");
    ...
    [TestMethod] public void Test_IMPORT_XLS_LAST_COLUMN_sql() => TestScript(@"IMPORT XLS LAST_COLUMN.sql");
