...
public class ZForm : Form
{
    ...
    protected override void WndProc(ref Message m)
    {
        ...
        if (m.Msg == WM_NCHITTEST && FormBorderStyle == FormBorderStyle.Sizable && SizeGripStyle != SizeGripStyle.Hide)
        {
            ...
            if (
                point.X >= formSize.Width - gripSize
                && point.Y >= formSize.Height - gripSize
                && formSize.Height >= gripSize
            )
            {
