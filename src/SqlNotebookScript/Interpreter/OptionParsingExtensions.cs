...
public static class OptionParsingExtensions
{
    ...
    public static T GetOption<T>(
        this Ast.OptionsList optionsList,
        string name,
        ScriptRunner runner,
        ScriptEnv env,
        T defaultValue
    ...
    public static Encoding GetOptionEncoding(
        this Ast.OptionsList optionsList,
        string name,
        ScriptRunner runner,
        ScriptEnv env
    ...
    public static long GetOptionLong(
        this Ast.OptionsList optionsList,
        string name,
        ScriptRunner runner,
        ScriptEnv env,
    ...
    )
    {
        ...
        bool outOfRange = (minValue.HasValue && num < minValue.Value) || (maxValue.HasValue && num > maxValue.Value);
        if (outOfRange)
        {
