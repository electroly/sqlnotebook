...
public sealed class DateDiffFunction : CustomScalarFunction
{
    ...
    public override object Execute(IReadOnlyList<object> args)
    {
        ...
        {
            case DatePart.Year:
                return (long)endDate.Year - startDate.Year;
...
public sealed class GetDateFunction : CustomScalarFunction
{
    ...
    public override object Execute(IReadOnlyList<object> args) => DateTimeUtil.FormatDateTime(DateTime.Now);
}
...
public sealed class GetUtcDateFunction : CustomScalarFunction
{
    ...
    public override object Execute(IReadOnlyList<object> args) => DateTimeUtil.FormatDateTime(DateTime.UtcNow);
}
