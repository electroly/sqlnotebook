    ...
    r(l, [], function() {
            ...
            c.on("PreInit", function() {
                ...
                "Cut,Copy,Paste": function(e) {
                    ...
                    if ("paste" !== e || t.queryCommandEnabled(e) || (r = !0), r || !t.queryCommandSupported(e)) {
                        ...
                        //CHANGED: Implement paste by calling server
                        var xhr = new XMLHttpRequest();
                        xhr.open('POST', "/paste");
                        xhr.send();
                        //CHANGED: End of paste implementation
        ...
        return e.extend({
            ...
            renderHtml: function() {
                var e = this,
                    ...
                    a = "";
                return i = e.settings.image, i ? (r = "none", "string" != typeof i && (i = window.getSelection ? i[0] : i[1]), i = " style=\"background-image: url('" + i + "')\"") : i = "", o && (e.classes.add("btn-has-text"), a = '<span class="' + n + 'txt">' + e.encode(o) + "</span>"), r = e.settings.icon ? n + "ico " + n + "i-" + r : "", '<div id="' + t 
                    + '" class="needs-title ' //CHANGED: Added "needs-title" to the class list
                    + e.classes + '" tabindex="-1" aria-labelledby="' + t + '"><button role="presentation" type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + i + "></i>" : "") + a + "</button></div>"
            },
            bindStates: function() {
                function e(e) {
        ...
        function a(e) {
            ...
            u = i(), s({
                ...
                type: "menubutton",
                //CHANGED: "Formats" to "Styles"
                /*text: "Formats",*/
                text: "Styles",
                menu: u
            }), e.addButton("formatselect", function() {
                var n = [],
                    i = r(e.settings.block_formats || 
                        //CHANGED: "Preformatted" to "Code"
                ...
                var n = /*"Andale Mono=andale mono,monospace;Arial=arial,helvetica,sans-serif;Arial Black=arial black,sans-serif;Book Antiqua=book antiqua,palatino,serif;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Helvetica=helvetica,arial,sans-serif;Impact=impact,sans-serif;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco,monospace;Times New Roman=times new roman,times,serif;Trebuchet MS=trebuchet ms,geneva,sans-serif;Verdana=verdana,geneva,sans-serif;Webdings=webdings;Wingdings=wingdings,zapf dingbats",*/
                        "Arial=arial;Arial Black=arial black,sans-serif;Book Antiqua=book antiqua,palatino,serif;Calibri=calibri;Cambria=cambria;Candara=candara;Comic Sans MS=comic sans ms,sans-serif;Consolas=consolas;Corbel=corbel;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Tahoma=tahoma,arial,helvetica,sans-serif;Times New Roman=times new roman,times,serif;Trebuchet MS=trebuchet ms,geneva,sans-serif;Verdana=verdana,geneva,sans-serif",
                    i = [],
                ...
                return s(i.split(" "), function(e) {
                    ...
                    type: "listbox",
                    //CHANGED: "Font Sizes" to "Size"
                    text: "Size", /*"Font Sizes",*/
                    tooltip: "Size", /*"Font Sizes",*/
                    values: n,
                    fixedWidth: !0,
        ...
        var i = e.extend({
            ...
            renderHtml: function() {
                var e = this,
                    ...
                    s = "";
                return o = e.settings.image, o ? (i = "none", "string" != typeof o && (o = window.getSelection ? o[0] : o[1]), o = " style=\"background-image: url('" + o + "')\"") : o = "", a && (e.classes.add("btn-has-text"), s = '<span class="' + r + 'txt">' + e.encode(a) + "</span>"), i = e.settings.icon ? r + "ico " + r + "i-" + i : "", e.aria("role", e.parent() instanceof n ? "menuitem" : "button"), '<div id="' + t 
                + '" class="needs-title ' //CHANGED: Added "needs-title" to the class list
                + e.classes + '" tabindex="-1" aria-labelledby="' + t + '"><button id="' + t + '-open" role="presentation" type="button" tabindex="-1">' + (i ? '<i class="' + i + '"' + o + "></i>" : "") + s + ' <i class="' + r + 'caret"></i></button></div>'
            },
            postRender: function() {
                var e = this;
...
! function(a, b) {
    ...
    d("tinymce/tableplugin/Utils", ["tinymce/Env"], function(a) {
        ...
        function j(f) {
            ...
            function q() {
                //CHANGED: Removed "Table properties" button
                ...
                //CHANGED: Removed "Cell properties" button
                ...
                //CHANGED: Removed "Row properties" button
            ...
            //CHANGED: Removed "Table properties" menu item
            ...
            f.addMenuItem("deletetable", {
                ...
                context: "table",
                menu: [
                //CHANGED: Removed "Cell properties" menu item
                /*{
                ...
                //CHANGED: Removed "Row properties" menu item
                /*{
                    text: "Row properties",
                    onclick: g("mceTableRowProps"),
                    onPostRender: m
...
//CHANGED: Don't display a popup form on Merge Cells if only one cell is selected
if (!f.dom.select("td[data-mce-selected],th[data-mce-selected]").length) {
    return;
}
//CHANGED: End of changed code
